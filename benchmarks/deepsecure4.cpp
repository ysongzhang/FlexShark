...
int main(int argc, char **argv)
{
    ...
    shark::span<u64> W1(2000 * 5625);
    shark::span<u64> B1(2000);

    shark::span<u64> W2(500 * 2000);
    shark::span<u64> B2(500);

    shark::span<u64> W3(19 * 500);
    shark::span<u64> B3(19);
    ...
    shark::utils::start_timer("deepsecure4");

    // shark::utils::start_timer("matmul1");
    auto a1 = matmul::call(batch_size, 5625, 2000, Image, W1);
    ...
    auto a4 = matmul::call(batch_size, 2000, 500, act1, W2);
    ...
    // shark::utils::start_timer("tanh2");
    auto act2 = tanh::call(f, a6);
    // shark::utils::stop_timer("tanh2");

    // shark::utils::start_timer("matmul3");
    auto a7 = matmul::call(batch_size, 500, 19, act2, W3);
    ...
    shark::utils::stop_timer("deepsecure4");
